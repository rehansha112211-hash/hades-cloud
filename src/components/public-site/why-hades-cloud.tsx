...
export function WhyHadesCloud() {
  return (
    ...
    >
      {/* Dark Minecraft forest atmosphere — VISIBLE */}
      <div className="absolute inset-0 z-0">
        <img
          src="/images/minecraft/forest-bg.jpg"
          alt="Minecraft dark forest biome"
...
export function SectionEyebrow({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 text-xs font-medium tracking-[0.25em] uppercase text-primary font-sans">
