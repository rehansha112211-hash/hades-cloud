  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      ...
      <span className="flex flex-col leading-none">
        <span className="font-display text-[16px] font-bold tracking-[0.18em] text-foreground">
          HADES
        </span>
        <span className="font-sans text-[10px] font-medium tracking-[0.42em] text-primary mt-1">
          CLOUD
        </span>
      </span>
    </span>
